package com.app.guttokback.subscription.application.service;
...
class UserSubscriptionServiceTest {
    ...
    public void savedUserSubscriptionTest() {
        ...
        // then
        UserSubscription userSubscription = userSubscriptionRepository.findAll().stream().findFirst().orElseThrow();
    ...
    public void userSubscriptionUpdateTest() {
        ...
        UserSubscription savedUserSubscription = createUserSubscription(user);
